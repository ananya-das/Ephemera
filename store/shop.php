    ...
    <div class = "wrapper">
      ...
      <div class = "body_content">
        <div class = "shop_content">
          <p class = "heading">PAPER GOODS</p>
          <div class = "category_1">
            <div class = "prod_1">
              <img src = "images/paper-good-2.png">
              <p class = "subheading">CALENDAR CARD VER.1</p>
            </div>
            <div class = "prod_2">
              <img src = "images/paper-good-1.png">
              <p class = "subheading">CALENDAR CARD VER.2</p>
            </div>
            <div class = "prod_3">
              <img src = "images/paper-good-3.png">
              <p class = "subheading">CALENDAR CARD VER.3</p>
            </div>
            <div class = "prod_4">
              <img src = "images/paper-5.png">
              <p class = "subheading">CALENDAR CARD VER.4</p>
            </div>
            <div class = "prod_4">
              <img src = "images/paper-good-4.png">
              <p class = "subheading">PAPER SCRAP SET</p>
            </div>
          </div>
          ...
          <div class = "category_2">
            <div class = "prod_1">
              ...
              <p class = "subheading">MINI PLAIN JOURNAL - STITCHED</p>
            </div>
            <div class = "prod_2">
              <img src = "images/journal-3.png">
              <p class = "subheading">MEDIUM PLAIN JOURNAL - STITCHED</p>
            </div>
            <div class = "prod_3">
              <img src = "images/journal-2.png">
              <p class = "subheading">PLAIN JOURNALS SET - STITCHED</p>
            </div>
            <div class = "prod_4">
              <img src = "images/journal-4.png">
              <p class = "subheading">GRID JOURNAL - RING BOUND</p>
            </div>
            <div class = "prod_5">
              <img src = "images/journal-5.png">
              <p class = "subheading">GRID JOURNAL - STITCHED</p>
            </div>
          </div>
          <p class = "heading">DIGITAL GOODS & PRINTABLES</p>
          <div class = "category_3">
            <div class = "prod_1">
              <img src = "images/digital-7.png">
              <p class = "subheading">CARAMEL SET - PRINTABLE/DIGITAL STICKER</p>
            </div>
            <div class = "prod_1">
              <img src = "images/digital-5.png">
              <p class = "subheading">MATCHA SET - PRINTABLE/DIGITAL STICKER</p>
            </div>
            <div class = "prod_1">
              <img src = "images/digital-6.png">
              <p class = "subheading">COFFEE SET - PRINTABLE/DIGITAL STICKER</p>
            </div>
            <div class = "prod_2">
              <img src = "images/digital-4.png">
              <p class = "subheading">DOTS VER.2 - PRINTABLE/DIGITAL STICKER</p>
            </div>
            <div class = "prod_3">
            ...
            <div class = "prod_4">
              ...
              <p class = "subheading">WALLPAPER - RAINBOW</p>
            </div>
            <div class = "prod_5">
              <img src = "images/digital-2.png">
              <p class = "subheading">WALLPAPER - LOW BATTERY</p>
            </div>
            <div class = "prod_5">
              <img src = "images/digital-9.png">
              <p class = "subheading">DIGITAL JOURNAL</p>
            </div>
          </div>
        </div>
      </div>
